  ...
  describe '!ENV tag' do
    ...
    context 'on seq' do
      ...
      [#| input                              | expected      |#
        ...
        context input do
          ...
          if expected == error
            it 'raises MissingEnvVariableError' do
              expect { subject }.to raise_error MissingEnvVariableError
            end
      ...
      context 'empty' do
        it 'raises MissingEnvVariableError' do
          expect { YAML.load('!ENV []') }.to raise_error MissingEnvVariableError
        end
      end
    end
    ...
    context 'on map' do
      it 'raises InvalidUsageError' do
        expect { YAML.load('!ENV { foo: 42 }') }.to raise_error InvalidUsageError
      end
    end
